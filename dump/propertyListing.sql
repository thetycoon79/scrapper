...
--
-- Host: 127.0.0.1    Database: propertyListing
-- ------------------------------------------------------
...
CREATE TABLE `property` (
  ...
  `propertyIntent` varchar(10) NOT NULL,
...
-- Dump completed on 2021-10-25 20:19:29
